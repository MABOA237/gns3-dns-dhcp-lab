...
## Overview
This projectis a virtual network lab built using GNS3. It implements core network services such as DNS and DHCP in a simulated environment.
...
## Current Progress
-Network topology created in GNS3
